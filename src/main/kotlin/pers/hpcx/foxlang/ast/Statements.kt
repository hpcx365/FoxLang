...
data class FoxEntityStatement(
    val value: FoxEntity,
) : FoxStatement

data class FoxFormattedString(
    val parts: List<FoxFormattedStringPart>,
    val isRaw: Boolean = false,
) : FoxStatement

sealed interface FoxFormattedStringPart

data class FoxFormattedText(
    val text: String,
) : FoxFormattedStringPart

data class FoxFormattedExpression(
    val expression: FoxStatement,
) : FoxFormattedStringPart

data class FoxSymbol(
    val name: String,
) : FoxStatement
...
data class FoxUnary(
    val operator: FoxUnaryOperator,
    val right: FoxStatement,
) : FoxStatement

data class FoxBinary(
...
data class FoxTypeBinding(
    val name: String,
    val type: FoxType,
) : FoxStatement

data class FoxFieldAccess(
    val target: FoxStatement,
    val name: String,
) : FoxStatement

data class FoxComponentAccess(
    val target: FoxStatement,
    val index: Int,
) : FoxStatement
