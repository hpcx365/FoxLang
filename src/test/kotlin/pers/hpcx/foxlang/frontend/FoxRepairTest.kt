...
""".trimStart()
    ...
    fun repairNamedActualParameterMissingValue() {
        ...
        assertTrue(
            analysis.context.matches(Statement, missingValueSpan).any { it.matchType == ParseMatchType.Expected },
        )
        assertTrue(
    ...
    fun repairDoWhileMissingWhileCondition() {
        ...
        assertTrue(
            analysis.context.matches(ParenthesizedStatement, tailSpan).any { it.matchType == ParseMatchType.Expected },
        )
        assertTrue(
